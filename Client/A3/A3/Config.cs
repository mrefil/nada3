...
namespace A3
{
    static public class Config
    {
        ...
        public const string cm_err_route = @"..\..\..\..\textFiles\err_args.txt";
        public const string cm_hlp_route = @"..\..\..\..\textFiles\hlp_file.txt";
        public const string cm_eut_route = @"..\..\..\..\textFiles\aut_file.txt";
        public const string cm_tst_route = @"..\..\..\..\textFiles\tst_logg.txt";
